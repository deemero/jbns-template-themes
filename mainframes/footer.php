  ...
  <div class="container" style="text-align: center;">
    ...
    <div class="row py-4">
      ...
      <?php 
          ...
          ?> -->
          <center> <div><img src="assets/SMJ.png" alt="" style=" width:190px;height:100px; object-fit: scale-down; "><br><br>
        <p style="font-size:16px" ><b style="color:black;">"SABAH MAJU JAYA"</b>
        </p></div></center>
